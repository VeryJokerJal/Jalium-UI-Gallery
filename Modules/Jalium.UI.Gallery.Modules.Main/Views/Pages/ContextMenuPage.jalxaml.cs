...
@"<!-- Basic ContextMenu (attached via ContextMenuService) -->
...
// Attach to an element via the ContextMenuService attached property
ContextMenuService.SetContextMenu(myBorder, contextMenu);
